import 'package:proyecto_final_cloud/features/puntos_de_peligro/models/puntos_de_peligro_model.dart';
...
class PuntosDePeligroService implements BaseService<PuntosDePeligroModel> {
  ...
  @override
  Stream<List<PuntosDePeligroModel>> findAllStream() => _firestoreService.collectionStream(
  ...
  @override
  Stream<PuntosDePeligroModel> findOneStream({required String id}) =>
  ...
  @override
  Future<void> createOne(PuntosDePeligroModel model) async => await _firestoreService.setData(
  ...
  Future<void> deleteOne(PuntosDePeligroModel model) async {
    await _firestoreService.deleteData(path: FirestorePath.puntosDePeligro(model.id.toString()));
  }

  @override
  Stream<List<PuntosDePeligroModel>> lastDocumentsStream(int n) => _firestoreService.collectionStream(
        path: FirestorePath.puntosDePeligros(),
        builder: (data) => PuntosDePeligroModel.fromJson(data!),
