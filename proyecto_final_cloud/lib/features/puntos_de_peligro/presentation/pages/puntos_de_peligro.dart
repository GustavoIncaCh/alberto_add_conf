...
class _PuntosDePeligroPageState extends State<PuntosDePeligroPage> {
  ...
  late BitmapDescriptor _icono_inseguro;
  late BitmapDescriptor _icono_seguro;
  ...
  _move(Position position){
    final camaraUpdate=CameraUpdate.newLatLng(LatLng(position.latitude,position.longitude));
